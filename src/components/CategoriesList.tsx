        ...
        <div className="mt-12 px-4 overflow-x-scroll scrollbar-hide">
            <div className="flex gap-4 md:gap-10">
                <Link href="/list?cat=test" className='flex-shrink-0 w-full sm:w-1/2 lg:w-[31%]'>
                    ...
                    <Image src='https://images.pexels.com/photos/15857058/pexels-photo-15857058/free-photo-of-de-madeira-fogao-forno-estufa.jpeg?auto=compress&cs=tinysrgb&w=800' alt='' fill sizes='20vw' className='object-cover rounded-md'/>
                    </div>
